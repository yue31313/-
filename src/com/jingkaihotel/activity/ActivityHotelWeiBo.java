 ...
 * 代码说明：宾馆微博
 */
public class ActivityHotelWeiBo extends Activity {
	 String url = "http://weibo.com/jingkaihotel";
		WebView webView;
	/* 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_hotel_wei_bo);
		 ...
		 WebSettings settings = webView.getSettings();
	        ...
	        webView.setWebChromeClient(new WebChromeClient() {
	            ...
	            public void onProgressChanged(WebView view, int newProgress) {
	            	...
	            	ActivityHotelWeiBo.this.setProgress(newProgress * 100);
	            }
	        });
