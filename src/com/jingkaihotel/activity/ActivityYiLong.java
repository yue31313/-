 ...
 * 代码说明：关于页面
 */
public class ActivityYiLong extends Activity {
	 String url = "http://hotel.elong.com/puyang/90104687";
	WebView webView;
	/* 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_yi_long);
		 ...
		 WebSettings settings = webView.getSettings();
	        ...
	        webView.setWebChromeClient(new WebChromeClient() {
	            ...
	            public void onProgressChanged(WebView view, int newProgress) {
	            	...
	            	ActivityYiLong.this.setProgress(newProgress * 100);
	            }
	        });
