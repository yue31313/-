 ...
 * 代码说明：资料集合
 */
public class ActivityZiLiao extends Activity {
	 String url = "http://url.cn/TUHABK";
		WebView webView;
	/* 
		 ...
		 WebSettings settings = webView.getSettings();
	        ...
	        webView.setWebChromeClient(new WebChromeClient() {
	            ...
	            public void onProgressChanged(WebView view, int newProgress) {
	            	...
	            	ActivityZiLiao.this.setProgress(newProgress * 100);
	            }
	        });
	...
	public void copyUrl(View view){
		...
		cmb.setText("宾馆相册：http://url.cn/f5UTKu,\n宾馆所有资料集合:http://url.cn/TUHABK");  
